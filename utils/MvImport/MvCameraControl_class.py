...
from utils.MvImport.PixelType_header import *
from utils.MvImport.CameraParams_const import *
from utils.MvImport.CameraParams_header import *
from utils.MvImport.MvErrorDefine_const import *

if platform.uname()[0] == "Windows":
    MvCamCtrldll = WinDLL("MvCameraControl.dll")
else:
    # TODO: Linux system support
